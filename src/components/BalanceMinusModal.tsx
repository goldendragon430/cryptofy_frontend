...
const BalanceMinusModal = () => {
  ...
  return (
    <>
      <button
        onClick={openModal}
        className="flex items-center justify-center gap-1 rounded-md border-[1px] bg-red-600 text-white p-2"
      >
        <AiOutlineMinusCircle /> Balance
      </button>
              ...
              >
                <Dialog.Panel className="flex w-full max-w-lg transform flex-col overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
                  <div className="flex items-center justify-between border-b border-gray-200 p-6">
                    <h1 className="text-xl font-medium">Subtract Balance</h1>
                    <button
                      onClick={closeModal}
...
export default BalanceMinusModal;
