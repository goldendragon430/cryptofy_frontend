...
const RejectModal = () => {
  ...
  return (
    <>
     <button 
     onClick={openModal}
     className='border-[1px] border-red-600 hover:bg-red-600 hover:text-white text-red-600 p-2 rounded-md flex justify-center items-center gap-1'><ImBlocked /> Remove</button>
