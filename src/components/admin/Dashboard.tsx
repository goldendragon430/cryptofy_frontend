  ...
  return (
    <div className="flex h-full w-[95%] flex-col items-center justify-center gap-8 bg-[#f3f3f9] py-[2rem] pt-[6rem]">
      ...
      <div className="flex w-full flex-col gap-3 px-2 lg:grid lg:grid-cols-3">
        ...
        <div className="relative flex w-full items-center justify-start gap-2 overflow-hidden rounded-md bg-white p-3 shadow-lg">
          <Link to={'withdrawal'} className="absolute right-[4px] top-[4px] rounded-md border-[1px] border-blue-950 p-[1px] text-xs text-blue-950">
            view all
          </Link >
          <div className="absolute bottom-[-0.65rem] right-[-0.65rem] -rotate-45 text-5xl text-blue-950 opacity-20">
            <FaRegMoneyBillAlt />
        ...
        <div className="relative flex w-full items-center justify-start gap-2 overflow-hidden rounded-md bg-white p-3 shadow-lg">
          ...
          <div>
            ...
            <p>Number of withdrwawals</p>
          </div>
        </div>
      </div>
      <div className="flex w-full flex-col gap-4 px-2 lg:grid lg:grid-cols-2">
        <div className="flex flex-col items-center justify-center gap-2 rounded-lg bg-white py-4 shadow-md lg:px-4">
          <div className="flex w-full items-center justify-between">
            <h1 className="text-2xl">Total deposit</h1>
            <select
              name="time"
        ...
        <div className="flex flex-col items-center justify-center gap-2 rounded-lg bg-white py-4 shadow-md lg:px-4">
          <div className="flex w-full items-center justify-between">
            <h1 className="text-2xl">Total withdrawal</h1>
            <select
              name="time"
        ...
        <div className="flex flex-col items-center justify-center gap-2 rounded-lg bg-white py-4 shadow-md lg:px-4">
          <div className="flex w-full items-center justify-between">
            <h1 className="text-2xl">Number of registrants</h1>
            <select
              name="time"
        ...
        <div className="flex flex-col items-center justify-center gap-2 rounded-lg bg-white p-4 shadow-md">
          <div className="flex w-full items-center justify-center">
            <h1 className="text-2xl">Login by country (last 30 days)</h1>
          </div>
          <Chart
            height={400}
            width={380}
